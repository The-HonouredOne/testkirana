    ...
    <div className="w-full max-w-full min-w-0 overflow-hidden bg-white rounded-2xl border border-gray-100 p-4 sm:p-5 sm:px-7 shadow-lg">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
        <div>
          ...
          <span className={`inline-flex items-center gap-1 text-xs font-semibold mt-2 px-2.5 py-1 rounded-full border ${
            isUp
        ...
        <div className="flex w-full sm:w-auto bg-gray-50 border border-gray-100 rounded-xl p-1 gap-1 self-start">
          {ranges.map((r) => (
            <button
              ...
              className={`flex-1 sm:flex-none text-xs font-bold px-2 sm:px-4 py-2 rounded-lg transition-all text-center ${
                range === r.key
